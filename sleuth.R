...
stab = read.table("/home/2025/aavalos4/PythonPipeline_Lexi_Avalos/sleuth_input.txt", header = TRUE)
...
write.table(sleuth_significant[, c("target_id", "test_stat", "pval", "qval")],
                    file="/home/2025/aavalos4/PythonPipeline_Lexi_Avalos/sleuth_output.tsv", 
